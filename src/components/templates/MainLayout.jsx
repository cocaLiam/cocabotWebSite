...
const MainLayout = () => {
  return (
    <div className="fixed inset-0 w-full h-full bg-neutral-900">
      ...
      <main
        className="relative w-full mt-[8.33vh] inset-0"
        style={{ height: "calc(100% - 8.33vh)" }}
      >
        {/* h-11/12는 남은 공간, mt-[8.33vh]는 TopNav 높이만큼 마진 */}
        ...
        <div
          ...
          className="absolute w-full h-full overflow-auto bg-gray-950"
        >
